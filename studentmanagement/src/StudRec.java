...
public class StudRec extends ViewElements
{
    ...
    private void addListeners(){
        //buttons
        bt1ok.addActionListener((ActionListener) new ButtonListener());
        ...
        tbModel.addListSelectionListener((ListSelectionListener) new StudTableListener());
        ...
        //keylisteners
        tf1mn.addKeyListener((KeyListener) new KeyboardListener());
    }
    ...
    public void setStudTable(){
        tb1stud = new JTable((TableModel) new StudModel());
    ...
    public void setSbjTable(){
        tb2sbj = new JTable((TableModel) new SbjModel());
    ...
    public void setEnrTable(){
        tb3stud = new JTable((TableModel) new EnrModel());
    ...
    public void setGrdTable(){
        tb4grd = new JTable((TableModel) new EnrModel());
