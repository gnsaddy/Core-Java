...
public class EnrollDialog extends JDialog {
    ...
    public void setStudTable(){
        ...
        tbnstud = new JTable((TableModel) new StudRec.StudModel());
    ...
    private class ButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent ev) {
            if(ev.getSource()==btnok){
                ...
                ViewElements.tb3stud.setModel((TableModel) new StudRec.EnrModel());
                ViewElements.tb4grd.setModel((TableModel) new StudRec.EnrModel());
    ...
    private class StudTableListener implements ListSelectionListener {
        public void valueChanged(ListSelectionEvent e) {
            ...
            if(lsm.isSelectionEmpty()) {
                ...
                AbstractTableModel tempMod = new AbstractTableModel() {
                    @Override
